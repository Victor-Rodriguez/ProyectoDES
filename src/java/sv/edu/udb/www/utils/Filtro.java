            ...
            switch(perfil){
                case 1:
                    if(url.contains("/administrador")){
                     ...
                     wrappedResponse.sendRedirect(wrappedRequest.getContextPath() + "/faces/administrador/index.xhtml");
                    break;
                case 2:
                    ...
                    wrappedResponse.sendRedirect(wrappedRequest.getContextPath() + "/faces/empleado/listarCategoria.xhtml");
                    break;
            }
